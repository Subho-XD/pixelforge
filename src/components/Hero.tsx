...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-[#05000a] text-white pt-20">
      
      {/* Mesh Gradient Dark Purple Background */}
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none bg-[#030008]">
        <motion.div 
          className="absolute top-[-10%] left-[-10%] w-[60vw] h-[60vw] bg-[#3b0764] rounded-full blur-[150px] opacity-20"
          animate={{ x: [0, 30, -10, 0], y: [0, -20, 30, 0], scale: [1, 1.05, 0.95, 1] }}
          transition={{ duration: 25, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div 
          className="absolute bottom-[-10%] right-[-10%] w-[60vw] h-[60vw] bg-[#1e1b4b] rounded-full blur-[150px] opacity-30"
          animate={{ x: [0, -30, 20, 0], y: [0, 30, -20, 0], scale: [1, 1.1, 0.9, 1] }}
          transition={{ duration: 30, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div 
          className="absolute top-[40%] left-[30%] w-[40vw] h-[40vw] bg-[#2e1065] rounded-full blur-[150px] opacity-15"
          animate={{ x: [0, 20, -20, 0], y: [0, 20, -20, 0], scale: [1, 0.9, 1.1, 1] }}
          transition={{ duration: 20, repeat: Infinity, ease: "easeInOut" }}
        />

        {/* Animated Fractal Noise - Subtle Film Grain */}
        <motion.div 
          className="absolute inset-[-50%] mix-blend-overlay opacity-[0.12] pointer-events-none" 
        ...
        {/* Central darkening to ensure text remains crisp */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(3,0,8,0)_0%,rgba(3,0,8,0.85)_100%)]" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 w-full max-w-6xl -mt-16">
        ...
        {isMounted && (
          ...
          >
            ...
            >
              ...
              <motion.div 
                className="absolute inset-0 w-full h-full text-[#d8b4fe] mix-blend-screen opacity-40"
                style={{ 
                  WebkitMaskImage: isMobile ? 'none' : maskImage,
                  maskImage: isMobile ? 'none' : maskImage,
        ...
        >
          <p className="text-[10px] md:text-xs tracking-[0.4em] uppercase text-white/50 font-sans border border-white/10 px-6 py-2 rounded-full backdrop-blur-md bg-white/5">
        ...
        <motion.h1 
          ...
          className="font-serif text-[18vw] sm:text-[15vw] md:text-[11rem] lg:text-[13rem] leading-[0.8] tracking-tighter text-white uppercase flex flex-col items-center w-full my-4 drop-shadow-2xl"
        >
          <span className="block">Graphic</span>
          <span className="block">Design</span>
          <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#b388ff] via-[#d8b4fe] to-[#8a2be2] pr-[0.1em]">
            Masterclass
          </span>
        </motion.h1>
        ...
        >
          <p className="text-[10px] md:text-xs tracking-[0.2em] uppercase text-white/80 max-w-lg mx-auto leading-loose font-sans">
            6 Months Online Course Including Live Sessions & Workshops
          </p>
        </motion.div>
